...
#pm-all { z-index: 2147483647; position: absolute; top: 0; right: 0; border:rgba(0,0,0,.4) solid 2px; padding:2px; width:110px; background-color: rgba(220, 220, 220, .3); border-top:none; border-right:none; font-size:12px; font-family: Courier;} \
#pm-all[open] { background-color:rgb(220, 220, 220); width: 600px;  } \
#pm-all > summary  span { color:blue; text-decoration: underline; cursor: pointer; position:absolute; top:0; right:2px; } \
